...
void main() async {
  ...
  final AuthLink authLink = AuthLink(
    getToken: () async =>
        'Bearer eyJhbGciOiJIUzI1NiJ9.eyJ0aWQiOjE2MDI3Mzc2NiwidWlkIjozMDQzNTgxMCwiaWFkIjoiMjAyMi0wNS0xMlQxNjo1ODo0MS4yNzVaIiwicGVyIjoibWU6d3JpdGUiLCJhY3RpZCI6MTIxMzc2MzQsInJnbiI6InVzZTEifQ.VxuIlWT6mBGAQ_M9nfkjBi1hWeWrgXzokBzwa2Qvbu4',
  );
